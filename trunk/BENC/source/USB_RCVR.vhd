...
--
-- Created:
--          by - mg32.bin (ecelinux23.ecn.purdue.edu)
--          at - 20:12:42 04/25/11
--
...
ARCHITECTURE struct OF USB_RCVR IS
   ...
   SIGNAL r_error_internal : std_logic;
   ...
   --FOR ALL : U_FCU USE ENTITY USB_keylogger_lib.U_FCU;
